...
class MainMenu(Menu):
    ...
    def _build_menu(self):
        ...
        self.add_button(MenuButton("ℹ️ Ayuda", "menu_help"), row=2)
...
class SecurityMenu(Menu):
    ...
    def _build_menu(self):
        ...
        self.add_button(MenuButton("← Atras", "menu_main"), row=8)
...
class HelpMenu(Menu):
    def __init__(self):
        title = "ℹ️ *AYUDA*\n\nWATCHMAN es un monitor de seguridad para tu Home Lab.\n\nFuncionalidades:\n• Monitorear conexiones de red\n• Verificar estado del firewall\n• Auditar intentos de acceso\n• Revisar servicios y procesos\n• Buscar vectores de escalada\n• Verificar certificados SSL\n\nAlgunos comandos requieren permisos sudo."
        super().__init__(title=title)
        self._build_menu()

    def _build_menu(self):
        self.add_button(MenuButton("← Atras", "menu_main"), row=0)
